...
\defn{
    We define the functor $\C:\cat{TOSet}\to\cat{Cat}_{\cat{SSet}}$ as follows. For any partially ordered set $J$, define $\C[J]$ to be the
    ...
    $\cat{SSet}\to\cat{Cat}_{\cat{SSet}}$. We denote this adjunction by $(\C,\N)$, and call the right adjoint the \term{homotopy-coherent nerve}
    functor.
}
