...
\thm{
    ...
    \footnote{This theorem remains unproofed in class. Its proof is in Corollaire 6.7 of \textit{Propri\'et\'es universelles et extensions 
    de Kan d\'eriv\'ees''.}}
}
...
\thm{
    ...
    natural transformation between $\Ho\cat{SSet}_*$-module functors $-\ov^L(S\ov^LK)$ and $-\ov^LK$.\footnote{This theorem remains unproofed 
    in class as well.}
}
