...
\defn{
    ...
    the natural transformation $$\Hom_{\catC^\catJ}(G,i_F)\to\Hom_{\catC^\catI}(i^*G,i^*i_*F)\to\Hom_{\catC^\catI}(i^*G,F)$$
...
\defn{
    We call a category \term{presentable} if the category is locally small, every object of the category is small,
