...
\defn{
    Suppose $\catC$ is a simpliciual set. An object $x$ in $\catC$ is called \term{strongly initial} if the projection $\catC_{x/}\to\catC$
...
of limits and colimits in Section \texttt{\color{ff0000}[ERROR! SECTION NOT FOUND]}. By now, we will just give the basic definitions and examples.
